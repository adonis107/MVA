...
\begin{figure*}[!htb]
    ...
    \begin{subfigure}{0.48\linewidth}
        \centering
        \includegraphics[width=0.8\linewidth]{img/transferability.png}
        \caption{}
    \end{subfigure}
    \hfill % Spacing between the two plots
    % Plot (b)
    \begin{subfigure}{0.48\linewidth}
        \centering
        \includegraphics[width=0.8\linewidth]{img/mapratio.png}
        \caption{}
    \end{subfigure}
...
\begin{figure*}[!htb] % Use figure* to span both columns for better readability
   \centering
   % Subfigure (a)
   \begin{subfigure}{0.48\linewidth}
      \centering
      \includegraphics[width=0.8\linewidth]{img/advtrained.png}
   ...
   \begin{subfigure}{0.48\linewidth}
      \centering
      \includegraphics[width=0.8\linewidth]{img/cleanperf.png}
