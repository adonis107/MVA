...
\begin{frame}{Stability -- Full Aperture under Noise}
  ...
  \vspace{-0.2cm}
  \begin{center}
    \includegraphics[width=0.62\textwidth]{Noise_Full_Aperture.png}
  \end{center}
...
\begin{frame}{Stability -- Partial Aperture under Noise}
  ...
  \vspace{-0.2cm}
  \begin{center}
    \includegraphics[width=0.8\textwidth]{Noise_Partial_Aperture.png}
  \end{center}
...
\begin{frame}{Stability -- Time-Dependent Broadband under Noise}
  ...
  \vspace{-0.2cm}
  \begin{center}
    \includegraphics[width=0.82\textwidth]{Noise_Time_Dependent.png}
  \end{center}
...
\begin{frame}{Conclusion}
  ...
  \begin{tcolorbox}[keybox, title=Summary of Findings, top=2pt, bottom=2pt]
    \begin{itemize}\setlength\itemsep{1pt}
      ...
      \item \textbf{Noise:} RT degrades gracefully; MUSIC is precision-first but collapses beyond a noise threshold.
    \end{itemize}
  \end{tcolorbox}
