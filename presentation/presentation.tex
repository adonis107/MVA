  ...
  \begin{column}{0.63\textwidth}
    \begin{tcolorbox}[keybox, title=Reverse-Time (RT) Migration, top=2pt, bottom=2pt]
      ...
      \begin{equation*}
        \tiny
      \begin{aligned}
        \mathcal{I}_{RT}(\bm{x}) = \frac{1}{2\pi}\!\int\!\! d\omega \sum_{r,s}
         \overline{\hat{G}_0(\omega, \bm{x}, \bm{x}_r)}\,\hat{u}_{rs}(\omega)
        \times\overline{\hat{G}_0(\omega, \bm{x}_s, \bm{x})}
      \end{aligned}
      \end{equation*}
    \end{tcolorbox}

    \begin{tcolorbox}[warnbox, title=Kirchhoff Migration (KM), top=2pt, bottom=2pt]
      \footnotesize
      ...
      \begin{equation*}
        \tiny
      \begin{aligned}
        \mathcal{I}_{KM}(\bm{x}) = \frac{1}{2\pi}\!\int\!\! d\omega \sum_{r,s}
         e^{-i\omega|\bm{x}-\bm{x}_r|}\,\hat{u}_{rs}(\omega)\,e^{-i\omega|\bm{x}_s - \bm{x}|}
      \end{aligned}
      \end{equation*}
    \end{tcolorbox}


    \begin{tcolorbox}[resultbox, title=MUSIC (Signal-Subspace Projection), top=2pt, bottom=2pt]
      \footnotesize
      Project onto the signal subspace:
      \vspace{-0.15cm}
      {\tiny
      $$\mathcal{I}_{MU}(\bm{x}) = |\langle \hat{g}(\omega, \bm{x}),\, v_1 \rangle|^2$$
      }
...
\begin{frame}{Theoretical Focal Spots -- Partial Aperture}
  ...
  \begin{minipage}[t]{0.48\textwidth}
    \begin{tcolorbox}[stressbox, title=Range ($z$), top=2pt, bottom=2pt]
      \scriptsize
      $$\mathcal{I}(z) \sim \left|\!\int_0^1\!\! e^{-i\frac{\pi}{2}s^2\frac{|z-z_{\mathrm{ref}}|}{r_l}}\,ds\right|^2$$
      \vspace{-0.25cm}
...
\begin{frame}{Stability -- Full Aperture under Noise}
  ...
  \vspace{-0.2cm}
  \begin{center}
    \includegraphics[width=0.62\textwidth]{Noise_Full_Aperture_short.png}
  \end{center}
...
\begin{frame}{Stability -- Partial Aperture under Noise}
  ...
  \vspace{-0.2cm}
  \begin{center}
    \includegraphics[width=0.8\textwidth]{Noise_Partial_Aperture_short.png}
  \end{center}
...
\begin{frame}{Stability -- Time-Dependent Broadband under Noise}
  ...
  \vspace{-0.2cm}
  \begin{center}
    \includegraphics[width=0.82\textwidth]{Noise_Time_Dependent_short.png}
  \end{center}
...
\begin{frame}{Stability -- Monte Carlo Analysis: RT vs.\ MUSIC}
  ...
  \begin{tcolorbox}[stressbox, title=RMSE of localization vs.\ noise level $\sigma$ (partial aperture)]
    \scriptsize Multiple noise realizations.
  \end{tcolorbox}
...
\begin{frame}{Conclusion}
  ...
  \begin{tcolorbox}[keybox, title=Summary of Findings, top=2pt, bottom=2pt]
    \begin{itemize}\setlength\itemsep{1pt}
      ...
      \item \textbf{Noise:} RT degrades gracefully; MUSIC is precision-first but collapses beyond a noise threshold. Computing with SVD seems less sensitive to noise.
    \end{itemize}
  \end{tcolorbox}
